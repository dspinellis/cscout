...
/* Copy SRC to DEST.  */
#if (!defined _HAVE_STRING_ARCH_strcpy && !1) \
...
/* Find the first occurrence of NEEDLE in HAYSTACK.  Newer gcc versions
   do this itself.  */
#if !defined _HAVE_STRING_ARCH_strstr && !1
...
strcmp("hello this is a test", "the world that never ends");
