...
#define int8x8x2_t struct { int8x8_t val[2]; }
#define int16x4x2_t struct { int16x4_t val[2]; }
#define int32x2x2_t struct { int32x2_t val[2]; }
#define int64x1x2_t struct { int64x1_t val[2]; }
#define float16x4x2_t struct { float16x4_t val[2]; }
#define float32x2x2_t struct { float32x2_t val[2]; }
#define poly8x8x2_t struct { poly8x8_t val[2]; }
#define poly16x4x2_t struct { poly16x4_t val[2]; }
#define uint8x8x2_t struct { uint8x8_t val[2]; }
#define uint16x4x2_t struct { uint16x4_t val[2]; }
#define uint32x2x2_t struct { uint32x2_t val[2]; }
#define float64x1x2_t struct { float64x1_t val[2]; }
#define uint64x1x2_t struct { uint64x1_t val[2]; }
#define int8x16x2_t struct { int8x16_t val[2]; }
#define int16x8x2_t struct { int16x8_t val[2]; }
#define int32x4x2_t struct { int32x4_t val[2]; }
#define int64x2x2_t struct { int64x2_t val[2]; }
#define float16x8x2_t struct { float16x8_t val[2]; }
#define float32x4x2_t struct { float32x4_t val[2]; }
#define float64x2x2_t struct { float64x2_t val[2]; }
#define poly8x16x2_t struct { poly8x16_t val[2]; }
#define poly16x8x2_t struct { poly16x8_t val[2]; }
#define poly64x2x2_t struct { poly64x2_t val[2]; }
#define poly64x1x2_t struct { poly64x1_t val[2]; }
#define uint8x16x2_t struct { uint8x16_t val[2]; }
#define uint16x8x2_t struct { uint16x8_t val[2]; }
#define uint32x4x2_t struct { uint32x4_t val[2]; }
#define uint64x2x2_t struct { uint64x2_t val[2]; }

#define int8x8x3_t struct { int8x8_t val[3]; }
#define int16x4x3_t struct { int16x4_t val[3]; }
#define int32x2x3_t struct { int32x2_t val[3]; }
#define int64x1x3_t struct { int64x1_t val[3]; }
#define float16x4x3_t struct { float16x4_t val[3]; }
#define float32x2x3_t struct { float32x2_t val[3]; }
#define poly8x8x3_t struct { poly8x8_t val[3]; }
#define poly16x4x3_t struct { poly16x4_t val[3]; }
#define uint8x8x3_t struct { uint8x8_t val[3]; }
#define uint16x4x3_t struct { uint16x4_t val[3]; }
#define uint32x2x3_t struct { uint32x2_t val[3]; }
#define float64x1x3_t struct { float64x1_t val[3]; }
#define uint64x1x3_t struct { uint64x1_t val[3]; }
#define int8x16x3_t struct { int8x16_t val[3]; }
#define int16x8x3_t struct { int16x8_t val[3]; }
#define int32x4x3_t struct { int32x4_t val[3]; }
#define int64x2x3_t struct { int64x2_t val[3]; }
#define float16x8x3_t struct { float16x8_t val[3]; }
#define float32x4x3_t struct { float32x4_t val[3]; }
#define float64x2x3_t struct { float64x2_t val[3]; }
#define poly8x16x3_t struct { poly8x16_t val[3]; }
#define poly16x8x3_t struct { poly16x8_t val[3]; }
#define poly64x2x3_t struct { poly64x2_t val[3]; }
#define poly64x1x3_t struct { poly64x1_t val[3]; }
#define uint8x16x3_t struct { uint8x16_t val[3]; }
#define uint16x8x3_t struct { uint16x8_t val[3]; }
#define uint32x4x3_t struct { uint32x4_t val[3]; }
#define uint64x2x3_t struct { uint64x2_t val[3]; }

#define int8x8x4_t struct { int8x8_t val[4]; }
#define int16x4x4_t struct { int16x4_t val[4]; }
#define int32x2x4_t struct { int32x2_t val[4]; }
#define int64x1x4_t struct { int64x1_t val[4]; }
#define float16x4x4_t struct { float16x4_t val[4]; }
#define float32x2x4_t struct { float32x2_t val[4]; }
#define poly8x8x4_t struct { poly8x8_t val[4]; }
#define poly16x4x4_t struct { poly16x4_t val[4]; }
#define uint8x8x4_t struct { uint8x8_t val[4]; }
#define uint16x4x4_t struct { uint16x4_t val[4]; }
#define uint32x2x4_t struct { uint32x2_t val[4]; }
#define float64x1x4_t struct { float64x1_t val[4]; }
#define uint64x1x4_t struct { uint64x1_t val[4]; }
#define int8x16x4_t struct { int8x16_t val[4]; }
#define int16x8x4_t struct { int16x8_t val[4]; }
#define int32x4x4_t struct { int32x4_t val[4]; }
#define int64x2x4_t struct { int64x2_t val[4]; }
#define float16x8x4_t struct { float16x8_t val[4]; }
#define float32x4x4_t struct { float32x4_t val[4]; }
#define float64x2x4_t struct { float64x2_t val[4]; }
#define poly8x16x4_t struct { poly8x16_t val[4]; }
#define poly16x8x4_t struct { poly16x8_t val[4]; }
#define poly64x2x4_t struct { poly64x2_t val[4]; }
#define poly64x1x4_t struct { poly64x1_t val[4]; }
#define uint8x16x4_t struct { uint8x16_t val[4]; }
#define uint16x8x4_t struct { uint16x8_t val[4]; }
#define uint32x4x4_t struct { uint32x4_t val[4]; }
#define uint64x2x4_t struct { uint64x2_t val[4]; }


#define bfloat16x4x2_t struct { __Bfloat16x4_t val[2]; }
#define bfloat16x8x2_t struct { __Bfloat16x8_t val[2]; }
#define bfloat16x4x3_t struct { __Bfloat16x4_t val[3]; }
#define bfloat16x8x3_t struct { __Bfloat16x8_t val[3]; }
#define bfloat16x4x4_t struct { __Bfloat16x4_t val[4]; }
#define bfloat16x8x4_t struct { __Bfloat16x8_t val[4]; }
