 ...
 *
 * $Id: cscout.cpp,v 1.89 2004/07/29 18:37:05 dds Exp $
 */
...
cgraph_page(FILE *fo, bool html)
{
	...
	buff1[0] = buff2[0] = 0;
	bool fun_name = !!swill_getvar("funname");
	bool file_name = !!swill_getvar("filename");
	bool path_name = !!swill_getvar("pathname");
...
index_page(FILE *of, void *data)
{
	...
	fprintf(of,
		...
		"<ul>\n"
		"<li> Function and macro call graph (HTML) with:<br>"
		"<a href=\"cgraph.html?all=1&funname=1\">function names</a>, "
		"<a href=\"cgraph.html?all=1&funname=1&filename=1\">file and function names</a>, "
		"<a href=\"cgraph.html?all=1&funname=1&pathname=1\">file path and function names</a>\n"
		"<li> Function and macro call graph (plain text) with:<br>"
		"<a href=\"cgraph.txt?all=1&funname=1\">function names</a>, "
		"<a href=\"cgraph.txt?all=1&funname=1&filename=1\">file and function names</a>, "
		"<a href=\"cgraph.txt?all=1&funname=1&pathname=1\">file path and function names</a>\n"
		"<li> Function and macro call graph in AT&amp;T GraphViz dot format:<br> "
		"<a href=\"cgraph_dot.txt?all=1\">plain</a>; with "
		"<a href=\"cgraph_dot.txt?all=1&funname=1\">function names</a>, "
		"<a href=\"cgraph_dot.txt?all=1&funname=1&filename=1\">file and function names</a>, "
		"<a href=\"cgraph_dot.txt?all=1&funname=1&pathname=1\">file path and function names</a>\n"
		"<li> Non-static function call graph (HTML) with:<br>"
		"<a href=\"cgraph.html?funname=1\">function names</a>, "
		"<a href=\"cgraph.html?funname=1&filename=1\">file and function names</a>, "
		"<a href=\"cgraph.html?funname=1&pathname=1\">file path and function names</a>\n"
		"<li> Non-static function call graph (plain text) with:<br>"
		"<a href=\"cgraph.txt?funname=1\">function names</a>, "
		"<a href=\"cgraph.txt?funname=1&filename=1\">file and function names</a>, "
		"<a href=\"cgraph.txt?funname=1&pathname=1\">file path and function names</a>\n"
		"<li> Non-static function call graph in AT&amp;T GraphViz dot format:<br> "
		"<a href=\"cgraph_dot.txt\">plain</a>; with "
		"<a href=\"cgraph_dot.txt?funname=1\">function names</a>, "
		"<a href=\"cgraph_dot.txt?funname=1&filename=1\">file and function names</a>, "
		"<a href=\"cgraph_dot.txt?funname=1&pathname=1\">file path and function names</a>\n"
...
main(int argc, char *argv[])
{
	...
	if (!compile_only) {
		...
		swill_handle("cgraph_dot.txt", cgraph_dot_page, NULL);
